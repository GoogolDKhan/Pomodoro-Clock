const projectName = "25-plus-5-clock";
  ...
  render() {
    return (
      <div className="length-control">
        ...
        <button
          className="btn-level"
          id={this.props.addID} //additionID
          onClick={this.props.onClick}
          value="+"
        >
...
class Timer extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="main-title">25 Plus 5 Clock</div>
        <TimerLengthControl
        ...
        <div className="author">
          ...
          2021 Made with &#10084; by <br />
          <a href="https://github.com/GoogolDKhan" target="_blank">
            Sarfaraz Khan
          </a>
        </div>
        <audio
